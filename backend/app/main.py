...
from app.routers import pcb, diagnosis, repair, test, image, report
...
def view_full_relational_table(db: Session = Depends(get_db)):
    ...
    <body>
        ...
        <p>Live SQL JOIN view matching ER Diagram: <code>pcbs &harr; diagnoses &harr; repairs &harr; tests &harr; images &harr; reports</code></p>
        <table>
            <thead>
                <tr>
                    <th>PCB ID</th>
