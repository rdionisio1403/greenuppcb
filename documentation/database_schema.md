...
This document defines the relational database architecture for the **GreenUp Laboratory Information System (LIS)**. The database is hosted on **PostgreSQL** and follows a normalized 1-to-Many entity relationship model matching the backend service implementation and ER specifications, including integrated user authentication and role tracking.
...
* **User Accountability:** Laboratory operations such as diagnostics, repairs, testing, and image capturing are linked to authenticated user accounts via foreign keys.
...
```mermaid
erDiagram
    USERS ||--o{ DIAGNOSES : "performs (1-N)"
    USERS ||--o{ REPAIRS : "executes (1-N)"
    USERS ||--o{ TESTS : "evaluates (1-N)"
    USERS ||--o{ IMAGES : "captures (1-N)"
...
```sql
-- Step 0: Register User (Technician/Tester)
INSERT INTO users (id, username, email, hashed_password, is_active)
VALUES (1, 'Sema', 'sema@greenuppcb.com', '$2b$12$e8i...hashed_pass_sample...', TRUE);
...
INSERT INTO diagnoses (id, pcb_id, user_id, diagnosis_date, fault_found, recommended_action)
VALUES (1, 1, 1, '2026-08-27 11:00:00', 'D4 diode shorted to GND, C12 capacitor bulging.', 'Replace shorted diode and capacitor.');

-- Step 4: Add Repair
INSERT INTO repairs (id, pcb_id, user_id, repair_date, actions_taken, components_replaced)
VALUES (1, 1, 1, '2026-08-27 14:30:00', 'Replaced shorted diode and capacitor; cleaned PCB flux residue.', '1x 1N4007, 1x 100uF 50V Low-ESR');

-- Step 5: Add Test Verification
INSERT INTO tests (id, pcb_id, user_id, test_date, test_type, result, notes)
VALUES (1, 1, 1, '2026-08-27 16:00:00', 'Functional & Power Rail Test', 'PASSED', 'Input: 24.0V DC, Output: 5.01V DC regulated.');

-- Step 6: Attach Intake Image (General - test_id IS NULL)
INSERT INTO images (id, pcb_id, test_id, user_id, category, filename_path, uploaded_at)
VALUES (1, 1, NULL, 1, 'before', 'uploads/images/pcb_1_intake.jpg', '2026-08-27 10:15:00');

-- Step 7: Attach Verification Image (Tied directly to Test #1)
INSERT INTO images (id, pcb_id, test_id, user_id, category, filename_path, uploaded_at)
VALUES (2, 1, 1, 1, 'after', 'uploads/images/pcb_1_test_output.jpg', '2026-08-27 16:15:00');
